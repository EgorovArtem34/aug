...
export interface IAsteroidsState {
  sortedAsteroids: IAsteroid[];
  setSortedAsteroids: (unit: IAsteroid[]) => void;
}

interface INextFetchUrl {
  nextFetchUrl: string;
  setNextFetchUrl: (unit: string) => void;
}

export interface IAppContext extends IAsteroidsState, INextFetchUrl {
